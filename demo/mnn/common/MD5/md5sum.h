...
// https://github.com/mmenxin/md5sum/blob/master/md5.cpp
#include <memory.h>
#include<iostream>
#include<string>
#include<fstream>
...
static void md5_update(unsigned int M[], unsigned int temp[]) {
...
static void md5_decode(unsigned int num, char* out) {
    out[8] = 0;
    for (int i = 0; i < 4; ++i) {
...
static std::string md5sum(const char* filename) {
    unsigned long long len = 0;
    unsigned int temp[] = { AA, BB, CC, DD };
