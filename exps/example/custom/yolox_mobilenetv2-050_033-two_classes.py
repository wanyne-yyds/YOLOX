...
class Exp(MyExp):
    def __init__(self):
        ...
        self.input_size = (256, 416)        #* 输入尺寸(高, 宽)
        self.multiscale_range = 5           #* 0 关闭多尺度
        self.data_dir = "/code/data/YOLOX-CocoFormat-BSD-Two_classes-2023-03-02_09:49:55"
        self.train_ann = "instances_train2017.json"
        self.val_ann = "instances_val2017.json"
        self.output_dir = "./YOLOX_outputs/YOLOX-BSD-Two_classes"

        # --------------- transform config ----------------- #
        self.mosaic_prob = 0.8              #* mosaic 概率
