...
CUDA_VISIBLE_DEVICES=2,3 python3 tools/train.py \
    ...
    -d 2 \
    -b 64 \
    -f /code/YOLOX/exps/example/custom/yolox_mobilenetv2-050_033_hyh.py \
    -o \
    --logger wandb \
        wandb-project YOLOX-BSD \
        wandb-name YOLOX-MobilenetV2-050_033-hyhdatset-Changetheratio-416x416-ChangeParam-$current_time \
